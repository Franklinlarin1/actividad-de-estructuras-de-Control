...
namespace ActividadEstructurasdeControl
{
    class Program
    {
        ...
        static void opciones()
        {
            ...
            Console.WriteLine("\t\t\t\t\t**  1-- Promgrama 1                            **");
            Console.WriteLine("\t\t\t\t\t**  2-- Promgrama 2                            **");
            Console.WriteLine("\t\t\t\t\t**  3-- Promgrama 3                            **");
            Console.WriteLine("\t\t\t\t\t**  4-- Promgrama 4                            **");
